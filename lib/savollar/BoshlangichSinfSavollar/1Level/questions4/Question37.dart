...
class _Question37State extends State<Question37> {
  ...
  final List<Map<String, dynamic>> draggableButtons = [
    {'color': Colors.white, 'label': '29'},
    {'color': Colors.white, 'label': '33'},
    {'color': Colors.white, 'label': '31'},
    {'color': Colors.white, 'label': '32'},
  ];
  ...
  Widget buildDragTarget(String targetId) {
    return DragTarget<Map<String, dynamic>>(
      ...
      builder: (context, candidateData, rejectedData) {
        ...
        if (label != null) {
          bool isCorrect = (droppedLabels["A"] == '31' && droppedLabels["B"] == '29' && droppedLabels["C"] == '32');
                          ...
                          children: [
                            ...
                            Center(
                              child: AnimatedButton(
                                ...
                                onPressed: () {
                                  if (!isChecked) {
                                    if ((droppedLabels["A"] == '31' && droppedLabels["B"] == '29' && droppedLabels["C"] == '32')) {
