  ...
  Widget buildDragTarget(String targetId) {
    return DragTarget<Map<String, dynamic>>(
      ...
      builder: (context, candidateData, rejectedData) {
        ...
        if (label != null) {
          bool isCorrect = (droppedLabels["A"] == '6' && droppedLabels["B"] == '9' && droppedLabels["C"] == '8');
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Image.asset(
                                    'assets/question3_images/Q24.png',
                                    width: 250,
                                    fit: BoxFit.contain,
                                  ),
                                ],
                          ...
                          children: [
                            ...
                            Center(
                              child: AnimatedButton(
                                ...
                                onPressed: () {
                                  if (!isChecked) {
                                    if ((droppedLabels["A"] == '6' && droppedLabels["B"] == '9' && droppedLabels["C"] == '8')) {
