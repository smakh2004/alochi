...
import 'package:alochi_math_app/savollar/BoshlangichSinfSavollar/1Level/questions1/Hint10.dart';
  ...
  Widget buildDragTarget(String targetId) {
    return DragTarget<Map<String, dynamic>>(
      ...
      builder: (context, candidateData, rejectedData) {
        ...
        if (label != null) {
          bool isCorrect = (droppedLabels["A"] == '8' && droppedLabels["B"] == '-' && droppedLabels["C"] == '2');
                      ...
                      children: [
                        ...
                        AnimatedButton(
                          ...
                          onPressed: () {
                            if (!isChecked) {
                              // ✅ Check both answers
                              if ((droppedLabels["A"] == '8' && droppedLabels["B"] == '-' && droppedLabels["C"] == '2')) {
