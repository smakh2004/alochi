      ...
      builder: (context, candidateData, rejectedData) {
        ...
        if (label != null) {
          return AnimatedButton(
            ...
            height: 54,
            color: isChecked
                ? ((droppedLabels['A'] == '4' && droppedLabels['B'] == '1') ? lightGreen : lightRed)
                : Colors.white,
            onPressed: () {
              if (!isChecked) {
                setState(() {
            ...
            child: Container(
              decoration: BoxDecoration(
                border: Border.all(
                  color: isChecked
                    ? ((droppedLabels['A'] == '4' && droppedLabels['B'] == '1') ? buttonGreen : buttonRed)
                    : greyColor, width: 2
                ),
                          ...
                          children: [
                            ...
                            Center(
                              child: AnimatedButton(
                                ...
                                onPressed: () {
                                  if (!isChecked) {
                                    if ((droppedLabels["A"] == '4' && droppedLabels["B"] == '1')) {
