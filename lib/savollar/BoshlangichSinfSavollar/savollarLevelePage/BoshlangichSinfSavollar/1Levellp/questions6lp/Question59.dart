...
class Question59 extends StatefulWidget {
  ...
  @override
  State<Question59> createState() => _Question59State();
}

class _Question59State extends State<Question59> {
  ...
  final List<Map<String, dynamic>> draggableButtons = [
    {'color': Colors.white, 'label': '34'},
    {'color': Colors.white, 'label': '15'},
    {'color': Colors.white, 'label': '25'},
    {'color': Colors.white, 'label': '54'},
  ];
  ...
  Widget buildDragTarget(String targetId) {
    return DragTarget<Map<String, dynamic>>(
      ...
      builder: (context, candidateData, rejectedData) {
        ...
        if (label != null) {
          bool isCorrect = (droppedLabels["A"] == '54' && droppedLabels["B"] == '15' && droppedLabels["C"] == '25');
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Image.asset(
                                    'assets/question5_images/Q59.png',
                                    width: 250,
                                    fit: BoxFit.contain,
                                  ),
                                ],
                              ...
                              Row(
                                ...
                                children: [
                                  Image.asset(
                                    'assets/question3_images/burger24.png',
                                    width: 50,
                                    fit: BoxFit.contain,
                                  ),
                                  ...
                                  const SizedBox(width: 10),
                                  Image.asset(
                                    'assets/question_images/Cheese.png',
                                    width: 50,
                                    fit: BoxFit.contain,
                                  ),
                                  const SizedBox(width: 10),
                              ...
                              Row(
                                ...
                                children: [
                                  Image.asset(
                                    'assets/question3_images/strawberry24.png',
                                    width: 50,
                                    fit: BoxFit.contain,
                                  ),
                                  const SizedBox(width: 10),
                                  ...
                                  const SizedBox(width: 10),
                                  Image.asset(
                                    'assets/question3_images/grape24.png',
                                    width: 50,
                                    fit: BoxFit.contain,
                                  ),
                                  const SizedBox(width: 10),
                          ...
                          children: [
                            ...
                            Center(
                              child: AnimatedButton(
                                ...
                                onPressed: () {
                                  if (!isChecked) {
                                    if ((droppedLabels["A"] == '54' && droppedLabels["B"] == '15' && droppedLabels["C"] == '25')) {
