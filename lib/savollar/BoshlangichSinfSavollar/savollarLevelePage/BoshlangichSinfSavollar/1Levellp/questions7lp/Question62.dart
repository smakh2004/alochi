                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  const Text('=', style: TextStyle(fontFamily: Font, fontSize: 40, color: questionColor)),
                                  const SizedBox(width: 5),
                                  const Text('96', style: TextStyle(fontFamily: Font, fontSize: 40, color: questionColor)),
                                ],
                              ),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  const Text('=', style: TextStyle(fontFamily: Font, fontSize: 40, color: questionColor)),
                                  const SizedBox(width: 5),
                                  const Text('42', style: TextStyle(fontFamily: Font, fontSize: 40, color: questionColor)),
                                ],
                              ),
                              const SizedBox(height: 10),
