  ...
  Widget buildDragTarget(String targetId) {
    return DragTarget<Map<String, dynamic>>(
      ...
      builder: (context, candidateData, rejectedData) {
        ...
        if (label != null) {
          bool isCorrect = ((droppedLabels["A"] == '8' && droppedLabels["B"] == '-' && droppedLabels["C"] == '2') || (droppedLabels["A"] == '2' && droppedLabels["B"] == '-' && droppedLabels["C"] == '8'));
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Image.asset(
                                    'assets/question5_images/Q41.png',
                                    width: 290,
                                    fit: BoxFit.contain,
                                  ),
                                ],
                      ...
                      children: [
                        ...
                        AnimatedButton(
                          ...
                          onPressed: () {
                            if (!isChecked) {
                              // ✅ Check both answers
                              if ((droppedLabels["A"] == '8' && droppedLabels["B"] == '-' && droppedLabels["C"] == '2') || (droppedLabels["A"] == '2' && droppedLabels["B"] == '-' && droppedLabels["C"] == '8')) {
