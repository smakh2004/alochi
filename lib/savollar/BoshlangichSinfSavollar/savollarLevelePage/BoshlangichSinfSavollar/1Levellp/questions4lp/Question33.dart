...
class _Question33State extends State<Question33> {
  ...
  final List<Map<String, dynamic>> draggableButtons = [
    {'color': Colors.white, 'label': '39'},
    {'color': Colors.white, 'label': '28'}, 
    {'color': Colors.white, 'label': '59'}, 
    {'color': Colors.white, 'label': '49'}, 
  ];
                                    ...
                                    builder: (context, candidateData, rejectedData) {
                                      return droppedColor == null
                                          ...
                                          : AnimatedButton(
                                              ...
                                              height: 54,
                                              color: isChecked
                                              ? (droppedLabel == '49' ? lightGreen : lightRed)
                                              : droppedColor!,
                                              onPressed: () {
                                                if (!isChecked) {
                                                  setState(() {
                                              ...
                                              child: Container(
                                                decoration: BoxDecoration(
                                                  border: Border.all(
                                                    color: isChecked
                                                        ? (droppedLabel == '49' ? buttonGreen : buttonRed)
                                                        : greyColor,
                                                    width: 2,
                                                  ),
                                                  borderRadius: BorderRadius.circular(12),
