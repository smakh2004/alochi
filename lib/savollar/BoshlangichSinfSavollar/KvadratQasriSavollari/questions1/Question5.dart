...
import 'package:alochi_math_app/savollar/BoshlangichSinfSavollar/KvadratQasriSavollari/questions1/Hint5.dart';
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Image.asset(
                                    'assets/question_images/IceCream1.png',
                                    width: 70,
                                    fit: BoxFit.contain,
                                  ),
                                  ...
                                  const SizedBox(width: 5),
                                  Image.asset(
                                    'assets/question_images/IceCream2.png',
                                    width: 110,
                                    fit: BoxFit.contain,
                                  ),
                                  const SizedBox(width: 5),
                                    ...
                                    builder: (context, candidateData, rejectedData) {
                                      return droppedColor == null
                                          ...
                                          : AnimatedButton(
                                              ...
                                              height: 54,
                                              color: isChecked
                                              ? (droppedLabel == '7' ? lightGreen : lightRed)
                                              : droppedColor!,
                                              onPressed: () {
                                                if (!isChecked) {
                                                  setState(() {
                                              ...
                                              child: Container(
                                                decoration: BoxDecoration(
                                                  border: Border.all(
                                                    color: isChecked
                                                        ? (droppedLabel == '7' ? buttonGreen : buttonRed)
                                                        : greyColor,
                                                    width: 2,
                                                  ),
                                                  borderRadius: BorderRadius.circular(12),
                              ...
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  PageRouteBuilder(
                                    ...
                                    pageBuilder: (_, __, ___) => const Hint5(),
