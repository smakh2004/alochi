      ...
      builder: (context, candidateData, rejectedData) {
        ...
        if (label != null) {
          return AnimatedButton(
            ...
            height: 54,
            color: isChecked
                ? ((label == '4' || label == '2') ? lightGreen : lightRed)
                : Colors.white,
            onPressed: () {
              if (!isChecked) {
                setState(() {
            ...
            child: Container(
              decoration: BoxDecoration(
                border: Border.all(
                  color: isChecked
                    ? ((label == '4' || label == '2') ? buttonGreen : buttonRed)
                    : greyColor, width: 2
                ),
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Image.asset(
                                    'assets/question4_images/Q35.png',
                                    width: 230,
                                    fit: BoxFit.contain,
                                  ),
                          ...
                          children: [
                            ...
                            Center(
                              child: AnimatedButton(
                                ...
                                onPressed: () {
                                  if (!isChecked) {
                                    if ((droppedLabels["A"] == '4' && droppedLabels["B"] == '2') ||
                                        (droppedLabels["A"] == '2' && droppedLabels["B"] == '4')) {
