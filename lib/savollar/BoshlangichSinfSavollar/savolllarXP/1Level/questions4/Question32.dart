  ...
  Widget buildDragTarget(String targetId) {
    return DragTarget<Map<String, dynamic>>(
      ...
      builder: (context, candidateData, rejectedData) {
        ...
        if (label != null) {
          bool isCorrect = (droppedLabels["A"] == '55' && droppedLabels["B"] == '15' && droppedLabels["C"] == '27');
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Image.asset(
                                    'assets/question4_images/Q32.png',
                                    width: 250,
                                    fit: BoxFit.contain,
                                  ),
                                ],
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  const SizedBox(width: 10),
                                  Image.asset(
                                    'assets/question3_images/apple24.png',
                                    width: 50,
                                    fit: BoxFit.contain,
                                  ),
                                  const SizedBox(width: 10),
                          ...
                          children: [
                            ...
                            Center(
                              child: AnimatedButton(
                                ...
                                onPressed: () {
                                  if (!isChecked) {
                                    if ((droppedLabels["A"] == '55' && droppedLabels["B"] == '15' && droppedLabels["C"] == '27')) {
