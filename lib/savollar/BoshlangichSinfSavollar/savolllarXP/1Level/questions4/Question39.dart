...
import 'package:alochi_math_app/savollar/BoshlangichSinfSavollar/savolllarXP/1Level/questions1/Hint4.dart';
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Image.asset(
                                    'assets/question4_images/Q39.png',
                                    width: 200,
                                    fit: BoxFit.contain,
                                  ),
                                    ...
                                    builder: (context, candidateData, rejectedData) {
                                      return droppedColor == null
                                          ...
                                          : AnimatedButton(
                                              ...
                                              height: 54,
                                              color: isChecked
                                              ? (droppedLabel == '3' ? lightGreen : lightRed)
                                              : droppedColor!,
                                              onPressed: () {
                                                if (!isChecked) {
                                                  setState(() {
                                              ...
                                              child: Container(
                                                decoration: BoxDecoration(
                                                  border: Border.all(
                                                    color: isChecked
                                                        ? (droppedLabel == '3' ? buttonGreen : buttonRed)
                                                        : greyColor,
                                                    width: 2,
                                                  ),
                                                  borderRadius: BorderRadius.circular(12),
