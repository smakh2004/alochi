                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Image.asset(
                                    'assets/question2_images/IceCream.png',
                                    width: 50,
                                    fit: BoxFit.contain,
                                  ),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  const SizedBox(width: 5),
                                  Image.asset(
                                    'assets/question2_images/Burger.png',
                                    width: 50,
                                    fit: BoxFit.contain,
                                  ),
                                  const SizedBox(width: 5),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  const SizedBox(width: 5),
                                  Image.asset(
                                    'assets/question2_images/2strawberry.png',
                                    width: 50,
                                    fit: BoxFit.contain,
                                  ),
                                  const Text(
                              ...
                              Row(
                                ...
                                children: [
                                  Image.asset(
                                    'assets/question2_images/1strawberry.png',
                                    width: 50,
                                    fit: BoxFit.contain,
                                  ),
                                  const SizedBox(width: 5),
                                  ...
                                  const SizedBox(width: 5),
                                  Image.asset(
                                    'assets/question_images/Burger.png',
                                    width: 50,
                                    fit: BoxFit.contain,
                                  ),
                                  const SizedBox(width: 5),
                                    ...
                                    builder: (context, candidateData, rejectedData) {
                                      return droppedColor == null
                                          ...
                                          : AnimatedButton(
                                              ...
                                              height: 54,
                                              color: isChecked
                                              ? (droppedLabel == '16' ? lightGreen : lightRed)
                                              : droppedColor!,
                                              onPressed: () {
                                                if (!isChecked) {
                                                  setState(() {
                                              ...
                                              child: Container(
                                                decoration: BoxDecoration(
                                                  border: Border.all(
                                                    color: isChecked
                                                        ? (droppedLabel == '16' ? buttonGreen : buttonRed)
                                                        : greyColor,
                                                    width: 2,
                                                  ),
                                                  borderRadius: BorderRadius.circular(12),
