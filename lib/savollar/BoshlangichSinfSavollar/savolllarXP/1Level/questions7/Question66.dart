...
class _Question66State extends State<Question66> {
  ...
  final List<Map<String, dynamic>> draggableButtons = [
    {'color': Colors.white, 'label': '48'},
    {'color': Colors.white, 'label': '46'},
    {'color': Colors.white, 'label': '50'},
  ...
  Widget buildDragTarget(String targetId) {
    return DragTarget<Map<String, dynamic>>(
      ...
      builder: (context, candidateData, rejectedData) {
        ...
        if (label != null) {
          bool isCorrect = (droppedLabels["A"] == '46' && droppedLabels["B"] == '50' && droppedLabels["C"] == '48');
                          ...
                          children: [
                            ...
                            Center(
                              child: AnimatedButton(
                                ...
                                onPressed: () {
                                  if (!isChecked) {
                                    if ((droppedLabels["A"] == '46' && droppedLabels["B"] == '50' && droppedLabels["C"] == '48')) {
