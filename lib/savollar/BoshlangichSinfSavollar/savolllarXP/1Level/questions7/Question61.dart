...
import 'package:alochi_math_app/savollar/BoshlangichSinfSavollar/savolllarXP/1Level/questions1/Hint10.dart';
  ...
  Widget buildDragTarget(String targetId) {
    return DragTarget<Map<String, dynamic>>(
      ...
      builder: (context, candidateData, rejectedData) {
        ...
        if (label != null) {
          bool isCorrect = ((droppedLabels["A"] == '31' && droppedLabels["B"] == '+' && droppedLabels["C"] == '14') || (droppedLabels["A"] == '14' && droppedLabels["B"] == '+' && droppedLabels["C"] == '31'));
                      ...
                      children: [
                        ...
                        AnimatedButton(
                          ...
                          onPressed: () {
                            if (!isChecked) {
                              // ✅ Check both answers
                              if ((droppedLabels["A"] == '31' && droppedLabels["B"] == '+' && droppedLabels["C"] == '14') || (droppedLabels["A"] == '14' && droppedLabels["B"] == '+' && droppedLabels["C"] == '31')) {
