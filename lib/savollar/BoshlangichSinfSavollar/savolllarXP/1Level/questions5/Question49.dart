      ...
      builder: (context, candidateData, rejectedData) {
        ...
        if (label != null) {
          return AnimatedButton(
            ...
            height: 54,
            color: isChecked
                ? ((droppedLabels['A'] == '6' && droppedLabels['B'] == '2') ? lightGreen : lightRed)
                : Colors.white,
            onPressed: () {
              if (!isChecked) {
                setState(() {
            ...
            child: Container(
              decoration: BoxDecoration(
                border: Border.all(
                  color: isChecked
                    ? ((droppedLabels['A'] == '6' && droppedLabels['B'] == '2') ? buttonGreen : buttonRed)
                    : greyColor, width: 2
                ),
                          ...
                          children: [
                            ...
                            Center(
                              child: AnimatedButton(
                                ...
                                onPressed: () {
                                  if (!isChecked) {
                                    if ((droppedLabels["A"] == '6' && droppedLabels["B"] == '2')) {
