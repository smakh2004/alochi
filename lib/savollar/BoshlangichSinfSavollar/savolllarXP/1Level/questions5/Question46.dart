  ...
  Widget buildDragTarget(String targetId) {
    return DragTarget<Map<String, dynamic>>(
      ...
      builder: (context, candidateData, rejectedData) {
        ...
        if (label != null) {
          bool isCorrect = (droppedLabels["A"] == '17' && droppedLabels["B"] == '18' && droppedLabels["C"] == '16');
                          ...
                          children: [
                            ...
                            Center(
                              child: AnimatedButton(
                                ...
                                onPressed: () {
                                  if (!isChecked) {
                                    if ((droppedLabels["A"] == '17' && droppedLabels["B"] == '18' && droppedLabels["C"] == '16')) {
