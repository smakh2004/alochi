...
import 'package:alochi_math_app/savollar/BoshlangichSinfSavollar/savolllarXP/1Level/questions1/Hint3.dart';
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  const Text('=', style: TextStyle(fontFamily: Font, fontSize: 40, color: questionColor)),
                                  const SizedBox(width: 5),
                                  const Text('30', style: TextStyle(fontFamily: Font, fontSize: 40, color: questionColor)),
                                ],
                              ),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  const Text('=', style: TextStyle(fontFamily: Font, fontSize: 40, color: questionColor)),
                                  const SizedBox(width: 5),
                                  const Text('20', style: TextStyle(fontFamily: Font, fontSize: 40, color: questionColor)),
                                ],
                              ),
                              const SizedBox(height: 10),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  const Text('=', style: TextStyle(fontFamily: Font, fontSize: 40, color: questionColor)),
                                  const SizedBox(width: 5),
                                  const Text('9', style: TextStyle(fontFamily: Font, fontSize: 40, color: questionColor)),
                                ],
                              ),
                              const SizedBox(height: 10),
