...
import 'package:alochi_math_app/generated/l10n.dart'; // <-- localization import

class IntroPage5 extends StatefulWidget {
  final PageController controller;

  const IntroPage5({super.key, required this.controller});
...
class _IntroPage5State extends State<IntroPage5> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> options = [
      S.of(context).level_elementary,
      S.of(context).level_high_school,
                  ...
                  child: Padding(
                    ...
                    child: CustomPaint(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          S.of(context).math_level_question,
